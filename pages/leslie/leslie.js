...
Page({
  ...
  onLoad: function (options) {
    ...
    rect.animate("rotate", Math.PI * 5, { duration: 1000 }).start(3)
  },
  ...
  changeOrigin: function (e) {
    ...
    rect.setOrigin([60, 60]);
  },
  madeLine: function (e) {
    let ellipse = new Shape('ellipse', {
      x: 200, y: 50, a: 40, b: 80,
      fillStyle: "#00A0B0", rotate: Math.PI / 7, shadow: { blur: 2 }
    }, 'mix', true)
    this.wxCanvas.add(ellipse)
    ellipse.animate({ a: "+=100", b: "-=20" }).animate({ a: "-=100", b: "+=20" }).start(1)
  }
})